...
Every functionality of my service will have it's own class.
...
I may also implement a simple LRU cache with no TTL. (I know it is unneccessary.)
...
My testing strategy will be two fold.
...
And for the dependency integration I will create some explatory tests to understand dependency behaviour and make sure it does not behave unexpectedly.
...
For this service vertical sclaing can be done through sticky connections between load balancer and the service. By using sticky connections the client will always call the service their data resides in.
...
#### Caching
To reduce the calls to the dependency I will implement a two fold caching strategy.
