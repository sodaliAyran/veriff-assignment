...
class TestEncoderHandler(unittest.TestCase):
    ...
    def test_encode_over_image_limit_raises_exception(self, mock_data_hasher, mock_db_proxy):
    ...
    @patch('core.EncoderHandler.data_hasher')
    def test_encode_with_cached_image(self, mock_data_hasher,
    ...
    @patch('core.EncoderHandler.image_encoder_proxy')
    @patch('core.EncoderHandler.data_hasher')
    def test_encode_with_not_cached_image(self, mock_data_hasher,
                                                mock_image_encoder_proxy,
                                                mock_db_proxy):
        mock_data_hasher.hash = lambda hash_item: self.MOCK_IMAGE_HASH \
            if hash_item == self.MOCK_IMAGE_DATA else self.MOCK_SESSION_ID_HASH
